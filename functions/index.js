...
const hasuraEndpoint = functions.config().hasura.endpoint;
const hasuraAdminSecret = functions.config().hasura.adminsecret;

const client = new request.GraphQLClient(hasuraEndpoint, {
    headers: {
